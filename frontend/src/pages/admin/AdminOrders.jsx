          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
            <div className="bg-white rounded-xl p-4 border-2 border-blue-200 shadow-md">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs font-semibold text-gray-600 uppercase">Total Revenue</span>
              </div>
              <div className="text-2xl font-bold text-gray-900">{formatINR(stats.totalRevenue)}</div>
            </div>
            ...
            <div className="bg-white rounded-xl p-4 border-2 border-emerald-200 shadow-md">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs font-semibold text-gray-600 uppercase">Paid Orders</span>
              </div>
            ...
            <div className="mt-4 -mx-1 overflow-x-auto">
              <div className="flex gap-2 px-1 min-w-max whitespace-nowrap">
                {[
                  ...
                  { label: 'On the Way', value: 'on_the_way', count: orders.filter(o => o.status?.toLowerCase() === 'on_the_way').length },
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50 overflow-y-auto">
            <div className="bg-white rounded-2xl w-full max-w-4xl shadow-2xl">
              <div className="bg-gradient-to-r from-amber-500 to-orange-500 px-6 py-4 flex justify-between items-center rounded-t-2xl">
                <h3 className="text-xl font-bold text-white">Order Details - #{String(viewingOrder._id).slice(-6)}</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gray-50 p-4 rounded-lg border-2 border-gray-200">
                    ...
                    <div className="space-y-2 text-sm">
                      <div><span className="text-gray-600">Name:</span> <span className="font-semibold text-gray-900">{viewingOrder.user?.name || 'N/A'}</span></div>
                      <div><span className="text-gray-600">Email:</span> <span className="font-semibold text-gray-900">{viewingOrder.user?.email || 'N/A'}</span></div>
                    </div>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg border-2 border-gray-200">
                    <h4 className="text-sm font-bold text-gray-700 mb-3 flex items-center gap-2">
                    ...
                    {viewingOrder.address ? (
                      <div className="space-y-1 text-sm">
                        ...
                        <div className="text-gray-600">{viewingOrder.address.address}{viewingOrder.address.landmark ? `, ${viewingOrder.address.landmark}` : ''}</div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {viewingOrder.items?.map((item, idx) => (
                      <div key={idx} className="bg-gray-50 p-4 rounded-lg border-2 border-gray-200 flex items-start gap-4">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    {viewingOrder.razorpayPaymentId && (
                      <div className="flex justify-between">
                        ...
                        <span className="font-mono text-xs text-gray-700">{viewingOrder.razorpayPaymentId}</span>
                      </div>
                    )}
                    <div className="pt-2 border-t border-amber-300 flex justify-between">
                      <span className="font-bold text-gray-900">Total Amount:</span>
                      <span className="text-xl font-bold text-gray-900">{formatINR(viewingOrder.amount)}</span>
                    </div>
                  </div>
                </div>
              </div>
