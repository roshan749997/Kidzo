      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-3 rounded-xl bg-gradient-to-br from-pink-600 to-rose-600 text-white shadow-lg">
              <FiFileText className="h-6 w-6" />
            </div>
            <div>
              <h1 className="text-3xl sm:text-4xl font-bold text-gray-900">Manage Policies</h1>
              <p className="text-gray-600 mt-1">Edit Privacy Policy, Terms & Conditions, Shipping Policy, and Refund/Cancellation Policy topic-wise</p>
            </div>
          </div>
        </div>
              ...
              <div className="p-6 space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:border-pink-500 focus:ring-2 focus:ring-pink-200 outline-none transition-all"
                ...
                <div className="space-y-4">
                  ...
                  {policies[type].sections.length === 0 ? (
                    <div className="text-center py-8 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                      ...
                      <button
                        onClick={() => addSection(type)}
                        className="px-4 py-2 bg-pink-600 text-white rounded-lg font-semibold hover:bg-pink-700 transition-all flex items-center gap-2 mx-auto"
                      >
                        <FiPlus className="h-4 w-4" />
                        Add First Section
                      </button>
                      ...
                      <div key={index} className="border-2 border-gray-200 rounded-lg p-4 bg-gray-50">
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center gap-2">
                            <span className="px-3 py-1 bg-pink-600 text-white rounded-lg font-semibold text-sm">
                            ...
                            <div className="flex gap-1">
                              ...
                              <button
                                ...
                                title="Move down"
                              >
                                <FiArrowDown className="h-4 w-4 text-gray-600" />
                              </button>
                            </div>
                          </div>
                          <button
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            rows={6}
                            className="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:border-pink-500 focus:ring-2 focus:ring-pink-200 outline-none transition-all text-sm"
                ...
                <div className="flex justify-end pt-4 border-t border-gray-200">
                  <button
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-pink-600 to-rose-600 text-white rounded-lg font-semibold shadow-md hover:shadow-lg transition-all transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                  >
                    {saving[type] ? (
                      <>
